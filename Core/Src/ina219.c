...
void setCalibration_32V_custom(void) {
    // Shunt-amperage-voltage configuration calculator
    // https://forums.adafruit.com/download/file.php?id=84820&sid=57713431387b8073b0dfe16631d95a63

    // Set multipliers to convert raw current/power values
    ina219_calValue = 8192;
    ina219_currentDivider_mA = 10;
    ina219_powerMultiplier_mW = 2.00;
